...
lcrisks_2010 <- lcrisks_full %>%
  filter(year == 2010)

# Primary Year: 2015 only
lcrisks_2015 <- lcrisks_full %>%
  filter(year == 2015)

# Primary Year: 2020 only
lcrisks_2020 <- lcrisks_full %>%
  filter(year == 2020)

# Primary Year: 2010, 2015, and 2020 combined
lcrisks_3core <- lcrisks_full %>%
...
baseline_nhis <- summarize_baseline(lcrisks_full)
