...
# --- Load Data ---
# Macbook
nhis_lcrisks <- read_csv("~/Desktop/Comorbidity Project/nhis_lcrisks.csv")
nhis_raw <- read_csv("~/Desktop/Comorbidity Project/nhis_raw.csv")
# iMac
nhis_lcrisks <- read_csv("~/Google Drive/Other computers/My Macbook/Desktop/Comorbidity Project/nhis_lcrisks.csv")
nhis_raw <- read_csv("~/Google Drive/Other computers/My Macbook/Desktop/Comorbidity Project/nhis_raw.csv")
